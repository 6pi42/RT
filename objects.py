class Sphere():
	def __init__(self, typee, pos, rgb, tex, rad):
		self.type = typee
		self.pos = pos
		self.rgb = rgb
		self.tex = tex
...
class Plane():
	def __init__(self, typee, pos, rgb, tex, norm):
		self.type = typee
		self.pos = pos
		self.rgb = rgb
		self.tex = tex
...
class Cylinder():
	def __init__(self, typee, pos, rgb, tex, axis, rad):
		self.type = typee
		self.pos = pos
		self.rgb = rgb
		self.tex = tex
...
class Cone():
	def __init__(self, typee, pos, rgb, tex, axis, k):
		self.type = typee
		self.pos = pos
		self.rgb = rgb
		self.tex = tex
...
class Cube():
	def __init__(self, typee, pt1, pt2, rgb):
		self.pt1 = pt1
		self.pt2 = pt2
		self.rgb = rgb
		self.type = typee
...
class Triangle():
	def __init__(self, typee, pt1, pt2, pt3, rgb):
		self.pt1 = pt1
		self.pt2 = pt2
		self.pt3 = pt3
		self.rgb = rgb
...
class Cercle():
	def __init__(self, typee, pos, dire, rgb, rad):
		self.pos = pos
		self.dir = dire
		self.rgb = rgb
		self.rad = rad
